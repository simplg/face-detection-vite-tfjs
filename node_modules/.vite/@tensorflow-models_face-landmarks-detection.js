          ...
          try {
            ...
            switch (r = 0, o && (i3 = [2 & i3[0], o.value]), i3[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(o = s.trys, (o = o.length > 0 && o[o.length - 1]) || i3[0] !== 6 && i3[0] !== 2)) {
                  s = 0;
                  continue;
                }
...
var M = function(t) {
  return { startEndTensor: t, startPoint: slice(t, [0, 0], [-1, 2]), endPoint: slice(t, [0, 2], [-1, 2]) };
};
var I = { strides: [8, 16], anchors: [2, 6] };
function B(t, n) {
  var i, u, c;
  if (t.topLeft instanceof Tensor && t.bottomRight instanceof Tensor) {
    var h = tidy(function() {
      return [concat([slice(sub(n - 1, t.topLeft), 0, 1), slice(t.topLeft, 1, 1)]), concat([sub(n - 1, slice(t.bottomRight, 0, 1)), slice(t.bottomRight, 1, 1)])];
    });
    i = h[0], u = h[1], t.landmarks != null && (c = tidy(function() {
      var r = sub(tensor1d([n - 1, 0]), t.landmarks), o = tensor1d([1, -1]);
      return mul(r, o);
    }));
  } else {
    var l = t.topLeft, d = l[0], p = l[1], m = t.bottomRight, b = m[0], y = m[1];
    i = [n - 1 - d, p], u = [n - 1 - b, y], t.landmarks != null && (c = t.landmarks.map(function(t2) {
      return [n - 1 - t2[0], t2[1]];
    }));
  }
  var g = { topLeft: i, bottomRight: u };
  return c != null && (g.landmarks = c), t.probability != null && (g.probability = t.probability instanceof Tensor ? t.probability.clone() : t.probability), g;
}
function C(t, e) {
  return tidy(function() {
    var n;
    return n = t.hasOwnProperty("box") ? t.box : t, squeeze(function(t2, e2) {
      var n2 = mul(t2.startPoint, e2), r = mul(t2.endPoint, e2), o = concat2d([n2, r], 1);
      return M(o);
    }(n, e).startEndTensor);
  });
}
var O = function() {
  function v(n, r, o, i, s, a) {
    this.blazeFaceModel = n, this.width = r, this.height = o, this.maxFaces = i, this.anchorsData = function(t, e, n2) {
      for (var r2 = [], o2 = 0; o2 < n2.strides.length; o2++)
        for (var i2 = n2.strides[o2], s2 = Math.floor((e + i2 - 1) / i2), a2 = Math.floor((t + i2 - 1) / i2), u = n2.anchors[o2], c = 0; c < s2; c++)
          for (var h = i2 * (c + 0.5), l = 0; l < a2; l++)
            for (var f = i2 * (l + 0.5), d = 0; d < u; d++)
              r2.push([f, h]);
      return r2;
    }(r, o, I), this.anchors = tensor2d(this.anchorsData), this.inputSizeData = [r, o], this.inputSize = tensor1d([r, o]), this.iouThreshold = s, this.scoreThreshold = a;
  }
  return v.prototype.getBoundingBoxes = function(e, d, p) {
    return p === void 0 && (p = true), k(this, void 0, void 0, function() {
      var m, v2, y, g, P, w2, x2, E2, I2, B2, C2, O2, R2, T2, F2 = this;
      return L(this, function(U2) {
        switch (U2.label) {
          case 0:
            return m = tidy(function() {
              var t = image.resizeBilinear(e, [F2.width, F2.height]), o = mul(sub(div(t, 255), 0.5), 2), f = F2.blazeFaceModel.predict(o), d2 = squeeze(f), p2 = function(t2, e2, o2) {
                var i = slice(t2, [0, 1], [-1, 2]), u = add(i, e2), h = slice(t2, [0, 3], [-1, 2]), f2 = div(h, o2), d3 = div(u, o2), p3 = div(f2, 2), m3 = sub(d3, p3), v3 = add(d3, p3), b = mul(m3, o2), y2 = mul(v3, o2);
                return concat2d([b, y2], 1);
              }(d2, F2.anchors, F2.inputSize), m2 = slice(d2, [0, 0], [-1, 1]);
              return [d2, p2, squeeze(sigmoid(m2))];
            }), v2 = m[0], y = m[1], g = m[2], P = console.warn, console.warn = function() {
            }, w2 = image.nonMaxSuppression(y, g, this.maxFaces, this.iouThreshold, this.scoreThreshold), console.warn = P, [4, w2.array()];
          case 1:
            return x2 = U2.sent(), w2.dispose(), E2 = x2.map(function(t) {
              return slice(y, [t, 0], [1, -1]);
            }), d ? [3, 3] : [4, Promise.all(E2.map(function(t) {
              return k(F2, void 0, void 0, function() {
                var e2;
                return L(this, function(n) {
                  switch (n.label) {
                    case 0:
                      return [4, t.array()];
                    case 1:
                      return e2 = n.sent(), t.dispose(), [2, e2];
                  }
                });
              });
            }))];
          case 2:
            E2 = U2.sent(), U2.label = 3;
          case 3:
            for (I2 = e.shape[1], B2 = e.shape[2], C2 = d ? div([B2, I2], this.inputSize) : [B2 / this.inputSizeData[0], I2 / this.inputSizeData[1]], O2 = [], R2 = function(e2) {
              var n = E2[e2], i = tidy(function() {
                var o = M(n instanceof Tensor ? n : tensor2d(n));
                if (!p)
                  return o;
                var i2, s = x2[e2];
                return i2 = d ? slice(F2.anchors, [s, 0], [1, 2]) : F2.anchorsData[s], { box: o, landmarks: reshape(squeeze(slice(v2, [s, 5], [1, -1])), [6, -1]), probability: slice(g, [s], [1]), anchor: i2 };
              });
              O2.push(i);
            }, T2 = 0; T2 < E2.length; T2++)
              R2(T2);
            return y.dispose(), g.dispose(), v2.dispose(), [2, { boxes: O2, scaleFactor: C2 }];
        }
      });
    });
  }, v.prototype.estimateFaces = function(t, e, n, i) {
    return e === void 0 && (e = false), n === void 0 && (n = false), i === void 0 && (i = true), k(this, void 0, void 0, function() {
      var a, u, c, h, v2, b, y = this;
      return L(this, function(g) {
        switch (g.label) {
          case 0:
            return a = function(t2) {
              return t2 instanceof Tensor ? [t2.shape[0], t2.shape[1]] : [t2.height, t2.width];
            }(t), u = a[1], c = tidy(function() {
              return t instanceof Tensor || (t = browser_exports.fromPixels(t)), expandDims(cast(t, "float32"), 0);
            }), [4, this.getBoundingBoxes(c, e, i)];
          case 1:
            return h = g.sent(), v2 = h.boxes, b = h.scaleFactor, c.dispose(), e ? [2, v2.map(function(t2) {
              var e2 = C(t2, b), o = { topLeft: slice(e2, [0], [2]), bottomRight: slice(e2, [2], [2]) };
              if (i) {
                var a2 = t2, c2 = a2.landmarks, h2 = a2.probability, f = a2.anchor, d = mul(add(c2, f), b);
                o.landmarks = d, o.probability = h2;
              }
              return n && (o = B(o, u)), o;
            })] : [2, Promise.all(v2.map(function(t2) {
              return k(y, void 0, void 0, function() {
                var e2, r, o, s, a2, c2, h2, l, f, d, p, m = this;
                return L(this, function(v3) {
                  switch (v3.label) {
                    case 0:
                      return e2 = C(t2, b), i ? [3, 2] : [4, e2.array()];
                    case 1:
                      return a2 = v3.sent(), r = { topLeft: a2.slice(0, 2), bottomRight: a2.slice(2) }, [3, 4];
                    case 2:
                      return [4, Promise.all([t2.landmarks, e2, t2.probability].map(function(t3) {
                        return k(m, void 0, void 0, function() {
                    ...
                    case 3:
                      o = v3.sent(), s = o[0], a2 = o[1], c2 = o[2], h2 = t2.anchor, f = (l = b)[0], d = l[1], p = s.map(function(t3) {
                        return [(t3[0] + h2[0]) * f, (t3[1] + h2[1]) * d];
                      }), r = { topLeft: a2.slice(0, 2), bottomRight: a2.slice(2), landmarks: p, probability: c2 }, function(t3) {
                        t3.startEndTensor.dispose(), t3.startPoint.dispose(), t3.endPoint.dispose();
                      }(t2.box), t2.landmarks.dispose(), t2.probability.dispose(), v3.label = 4;
                    case 4:
                      return e2.dispose(), n && (r = B(r, u)), [2, r];
                  }
                });
              });
            }))];
...
function R(t) {
  var e = t === void 0 ? {} : t, n = e.maxFaces, r = n === void 0 ? 10 : n, o = e.inputWidth, i = o === void 0 ? 128 : o, s = e.inputHeight, a = s === void 0 ? 128 : s, u = e.iouThreshold, c = u === void 0 ? 0.3 : u, h = e.scoreThreshold, l = h === void 0 ? 0.75 : h, f = e.modelUrl;
  return k(this, void 0, void 0, function() {
    var t2;
    return L(this, function(e2) {
      switch (e2.label) {
        case 0:
          return f == null ? [3, 2] : [4, loadGraphModel(f)];
        case 1:
          return t2 = e2.sent(), [3, 4];
        case 2:
          return [4, loadGraphModel("https://tfhub.dev/tensorflow/tfjs-model/blazeface/1/default/1", { fromTFHub: true })];
        case 3:
          t2 = e2.sent(), e2.label = 4;
        case 4:
          return [2, new O(t2, i, a, r, c, l)];
      }
    });
  });
}
var T = { silhouette: [10, 338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 288, 397, 365, 379, 378, 400, 377, 152, 148, 176, 149, 150, 136, 172, 58, 132, 93, 234, 127, 162, 21, 54, 103, 67, 109], lipsUpperOuter: [61, 185, 40, 39, 37, 0, 267, 269, 270, 409, 291], lipsLowerOuter: [146, 91, 181, 84, 17, 314, 405, 321, 375, 291], lipsUpperInner: [78, 191, 80, 81, 82, 13, 312, 311, 310, 415, 308], lipsLowerInner: [78, 95, 88, 178, 87, 14, 317, 402, 318, 324, 308], rightEyeUpper0: [246, 161, 160, 159, 158, 157, 173], rightEyeLower0: [33, 7, 163, 144, 145, 153, 154, 155, 133], rightEyeUpper1: [247, 30, 29, 27, 28, 56, 190], rightEyeLower1: [130, 25, 110, 24, 23, 22, 26, 112, 243], rightEyeUpper2: [113, 225, 224, 223, 222, 221, 189], rightEyeLower2: [226, 31, 228, 229, 230, 231, 232, 233, 244], rightEyeLower3: [143, 111, 117, 118, 119, 120, 121, 128, 245], rightEyebrowUpper: [156, 70, 63, 105, 66, 107, 55, 193], rightEyebrowLower: [35, 124, 46, 53, 52, 65], rightEyeIris: [473, 474, 475, 476, 477], leftEyeUpper0: [466, 388, 387, 386, 385, 384, 398], leftEyeLower0: [263, 249, 390, 373, 374, 380, 381, 382, 362], leftEyeUpper1: [467, 260, 259, 257, 258, 286, 414], leftEyeLower1: [359, 255, 339, 254, 253, 252, 256, 341, 463], leftEyeUpper2: [342, 445, 444, 443, 442, 441, 413], leftEyeLower2: [446, 261, 448, 449, 450, 451, 452, 453, 464], leftEyeLower3: [372, 340, 346, 347, 348, 349, 350, 357, 465], leftEyebrowUpper: [383, 300, 293, 334, 296, 336, 285, 417], leftEyebrowLower: [265, 353, 276, 283, 282, 295], leftEyeIris: [468, 469, 470, 471, 472], midwayBetweenEyes: [168], noseTip: [1], noseBottom: [2], noseRightCorner: [98], noseLeftCorner: [327], rightCheek: [205], leftCheek: [425] };
function F(t) {
...
function S(t, e) {
  e === void 0 && (e = 1.5);
  var n = U(t), r = F(t), o = [e * r[0] / 2, e * r[1] / 2];
  return { startPoint: [n[0] - o[0], n[1] - o[1]], endPoint: [n[0] + o[0], n[1] + o[1]], landmarks: t.landmarks };
}
function D(t) {
  var e = U(t), n = F(t), r = Math.max.apply(Math, n) / 2;
  return { startPoint: [e[0] - r, e[1] - r], endPoint: [e[0] + r, e[1] + r], landmarks: t.landmarks };
}
var W = [[1, 0, 0], [0, 1, 0], [0, 0, 1]];
function z(t, e) {
  var n, r = Math.PI / 2 - Math.atan2(-(e[1] - t[1]), e[0] - t[0]);
...
function V(t, e) {
  for (var n = [], r = t.length, o = 0; o < r; o++) {
    n.push([]);
    for (var i = 0; i < r; i++)
      n[o].push(j(t[o], A(e, i)));
  }
  return n;
}
function _(t, e) {
  var n = Math.cos(t), r = Math.sin(t), o = [[n, -r, 0], [r, n, 0], [0, 0, 1]], i = V(H(e[0], e[1]), o);
  return V(i, H(-e[0], -e[1]));
}
var G = [13, T.midwayBetweenEyes[0]];
var K = [3, 2];
var N = T.leftEyeLower0;
var q = [N[0], N[N.length - 1]];
var J = T.rightEyeLower0;
var Q = [J[0], J[J.length - 1]];
var X = [{ key: "EyeUpper0", indices: [9, 10, 11, 12, 13, 14, 15] }, { key: "EyeUpper1", indices: [25, 26, 27, 28, 29, 30, 31] }, { key: "EyeUpper2", indices: [41, 42, 43, 44, 45, 46, 47] }, { key: "EyeLower0", indices: [0, 1, 2, 3, 4, 5, 6, 7, 8] }, { key: "EyeLower1", indices: [16, 17, 18, 19, 20, 21, 22, 23, 24] }, { key: "EyeLower2", indices: [32, 33, 34, 35, 36, 37, 38, 39, 40] }, { key: "EyeLower3", indices: [54, 55, 56, 57, 58, 59, 60, 61, 62] }, { key: "EyebrowUpper", indices: [63, 64, 65, 66, 67, 68, 69, 70] }, { key: "EyebrowLower", indices: [48, 49, 50, 51, 52, 53] }];
function Y(t, e, n, r) {
  for (var o = 0; o < X.length; o++) {
    var i = X[o], s = i.key, a = i.indices, u = T["" + n + s];
    if (r == null || r.includes(s))
...
var Z = function() {
  function e(t, e2, n, r, o, i, s) {
    this.regionsOfInterest = [], this.runsWithoutFaceDetector = 0, this.boundingBoxDetector = t, this.meshDetector = e2, this.irisModel = s, this.meshWidth = n, this.meshHeight = r, this.maxContinuousChecks = o, this.maxFaces = i;
  }
  return e.prototype.transformRawCoords = function(t, e2, n, r) {
    var o, i, s, a, u = this, c = F({ startPoint: e2.startPoint, endPoint: e2.endPoint }), h = [c[0] / this.meshWidth, c[1] / this.meshHeight], l = t.map(function(t2) {
      return [h[0] * (t2[0] - u.meshWidth / 2), h[1] * (t2[1] - u.meshHeight / 2), t2[2]];
    }), f = _(n, [0, 0]), d = l.map(function(t2) {
      return function(t3, e3) {
        return [j(t3, e3[0]), j(t3, e3[1])];
      }(t2, f).concat([t2[2]]);
    }), p = (i = [[(o = r)[0][0], o[1][0]], [o[0][1], o[1][1]]], s = [o[0][2], o[1][2]], a = [-j(i[0], s), -j(i[1], s)], [i[0].concat(a[0]), i[1].concat(a[1]), [0, 0, 1]]), m = U({ startPoint: e2.startPoint, endPoint: e2.endPoint }).concat([1]), v = [j(m, p[0]), j(m, p[1])];
    return d.map(function(t2) {
      return [t2[0] + v[0], t2[1] + v[1], t2[2]];
    });
  }, e.prototype.getLeftToRightEyeDepthDifference = function(t) {
    return t[q[0]][2] - t[Q[0]][2];
  }, e.prototype.getEyeBox = function(t, e2, n, r, o) {
    o === void 0 && (o = false);
    var s = D(S(this.calculateLandmarksBoundingBox([t[n], t[r]]), 2.3)), a = F(s), u = image.cropAndResize(e2, [[s.startPoint[1] / this.meshHeight, s.startPoint[0] / this.meshWidth, s.endPoint[1] / this.meshHeight, s.endPoint[0] / this.meshWidth]], [0], [64, 64]);
    return o && (u = image.flipLeftRight(u)), { box: s, boxSize: a, crop: u };
  }, e.prototype.getEyeCoords = function(t, e2, n, r) {
    r === void 0 && (r = false);
    for (var o = [], i = 0; i < 76; i++) {
      var s = t[3 * i], a = t[3 * i + 1], u = t[3 * i + 2];
      o.push([(r ? 1 - s / 64 : s / 64) * n[0] + e2.startPoint[0], a / 64 * n[1] + e2.startPoint[1], u]);
    }
    return { rawCoords: o, iris: o.slice(71) };
  }, e.prototype.getAdjustedIrisCoords = function(t, e2, n) {
    var r = t[T[n + "EyeUpper0"][3]][2], o = t[T[n + "EyeLower0"][4]][2], i = (r + o) / 2;
    return e2.map(function(t2, e3) {
      var n2 = i;
      return e3 === 2 ? n2 = r : e3 === 4 && (n2 = o), [t2[0], t2[1], n2];
    });
  }, e.prototype.predict = function(e2, r) {
    return x(this, void 0, void 0, function() {
      ...
      return E(this, function(f) {
        switch (f.label) {
          ...
          case 1:
            return s = f.sent(), a = s.boxes, c = s.scaleFactor, a.length === 0 ? (this.regionsOfInterest = [], [2, null]) : (h = a.map(function(t) {
              var e3, n, r2 = { startPoint: squeeze(t.box.startPoint).arraySync(), endPoint: squeeze(t.box.endPoint).arraySync() }, o = D(S((n = c, { startPoint: [(e3 = r2).startPoint[0] * n[0], e3.startPoint[1] * n[1]], endPoint: [e3.endPoint[0] * n[0], e3.endPoint[1] * n[1]] })));
              return w({}, o, { landmarks: t.landmarks.arraySync() });
            }), a.forEach(function(t) {
              t != null && t.startPoint != null && (t.startEndTensor.dispose(), t.startPoint.dispose(), t.endPoint.dispose());
            }), this.updateRegionsOfInterest(h), this.runsWithoutFaceDetector = 0, [3, 3]);
          case 2:
            this.runsWithoutFaceDetector++, f.label = 3;
          case 3:
            return [2, tidy(function() {
              return l.regionsOfInterest.map(function(o, s2) {
                var a2, c2 = o.landmarks.length >= 468, h2 = G[0], f2 = G[1];
                c2 === false && (h2 = K[0], f2 = K[1]), a2 = z(o.landmarks[h2], o.landmarks[f2]);
                var d = U({ startPoint: o.startPoint, endPoint: o.endPoint }), p = [d[0] / e2.shape[2], d[1] / e2.shape[1]], m = e2, y = W;
                a2 !== 0 && (m = image.rotateWithOffset(e2, a2, 0, p), y = _(-a2, d));
                var g = { startPoint: o.startPoint, endPoint: o.endPoint }, P = div(function(t, e3, n) {
                  var r2 = e3.shape[1], o2 = e3.shape[2], s3 = [[t.startPoint[1] / r2, t.startPoint[0] / o2, t.endPoint[1] / r2, t.endPoint[0] / o2]];
                  return image.cropAndResize(e3, s3, [0], n, "bilinear", 0);
                }(g, m, [l.meshHeight, l.meshWidth]), 255), x2 = l.meshDetector.predict(P), E2 = x2[1], k2 = x2[2], L2 = reshape(k2, [-1, 3]).arraySync();
                if (r) {
                  var M2 = l.getEyeBox(L2, P, q[0], q[1], true), I2 = M2.box, B2 = M2.boxSize, C2 = M2.crop, O2 = l.getEyeBox(L2, P, Q[0], Q[1]), R2 = O2.box, T2 = O2.boxSize, F2 = O2.crop, H2 = l.irisModel.predict(concat([C2, F2])).dataSync(), j2 = H2.slice(0, 228), A2 = l.getEyeCoords(j2, I2, B2, true), V2 = A2.rawCoords, N2 = A2.iris, J2 = H2.slice(228), X2 = l.getEyeCoords(J2, R2, T2), Z2 = X2.rawCoords, $2 = X2.iris, tt2 = l.getLeftToRightEyeDepthDifference(L2);
                  Math.abs(tt2) < 30 ? (Y(L2, V2, "left"), Y(L2, Z2, "right")) : tt2 < 1 ? Y(L2, V2, "left", ["EyeUpper0", "EyeLower0"]) : Y(L2, Z2, "right", ["EyeUpper0", "EyeLower0"]);
                  var et2 = l.getAdjustedIrisCoords(L2, N2, "left"), nt2 = l.getAdjustedIrisCoords(L2, $2, "right");
                  L2 = L2.concat(et2).concat(nt2);
                }
                var rt2 = l.transformRawCoords(L2, o, a2, y), ot2 = tensor2d(rt2), it2 = S(l.calculateLandmarksBoundingBox(rt2)), st2 = D(it2);
                return l.regionsOfInterest[s2] = w({}, st2, { landmarks: ot2.arraySync() }), { coords: tensor2d(L2, [L2.length, 3]), scaledCoords: ot2, box: it2, flag: squeeze(E2) };
              });
            })];
        }
      });
    ...
    for (var e2 = 0; e2 < t.length; e2++) {
      var n = t[e2], r = this.regionsOfInterest[e2], o = 0;
      if (r && r.startPoint) {
        var i = n.startPoint, s = i[0], a = i[1], u = n.endPoint, c = u[0], h = u[1], l = r.startPoint, f = l[0], d = l[1], p = r.endPoint, m = p[0], v = p[1], b = Math.max(s, f), y = Math.max(a, d), g = (Math.min(c, m) - b) * (Math.min(h, v) - y);
        o = g / ((c - s) * (h - a) + (m - f) * (v - a) - g);
      }
      o < 0.25 && (this.regionsOfInterest[e2] = n);
    }
    this.regionsOfInterest = this.regionsOfInterest.slice(0, t.length);
  }, e.prototype.clearRegionOfInterest = function(t) {
    this.regionsOfInterest[t] != null && (this.regionsOfInterest = this.regionsOfInterest.slice(0, t).concat(this.regionsOfInterest.slice(t + 1)));
  }, e.prototype.shouldUpdateRegionsOfInterest = function() {
    var t = this.regionsOfInterest.length, e2 = t === 0;
    return this.maxFaces === 1 || e2 ? e2 : t !== this.maxFaces && this.runsWithoutFaceDetector >= this.maxContinuousChecks;
...
function tt(t) {
  return x(this, void 0, void 0, function() {
    ...
    return E(this, function(b) {
      switch (b.label) {
        case 0:
          return e = t.maxContinuousChecks, n = e === void 0 ? 5 : e, r = t.detectionConfidence, o = r === void 0 ? 0.9 : r, i = t.maxFaces, s = i === void 0 ? 10 : i, a = t.iouThreshold, u = a === void 0 ? 0.3 : a, c = t.scoreThreshold, h = c === void 0 ? 0.75 : c, l = t.shouldLoadIrisModel, f = l === void 0 || l, d = t.modelUrl, p = t.detectorModelUrl, m = t.irisModelUrl, f ? [4, Promise.all([et(p, s, u, h), nt(d), rt(m)])] : [3, 2];
        case 1:
          return v = b.sent(), [3, 4];
        case 2:
...
function et(t, e, n, r) {
  return x(this, void 0, void 0, function() {
    return E(this, function(o) {
      return [2, R({ modelUrl: t, maxFaces: e, iouThreshold: n, scoreThreshold: r })];
    });
  });
}
function nt(t) {
  return x(this, void 0, void 0, function() {
    return E(this, function(e) {
      return t != null ? [2, loadGraphModel(t)] : [2, loadGraphModel("https://tfhub.dev/mediapipe/tfjs-model/facemesh/1/default/1", { fromTFHub: true })];
    });
  });
}
function rt(t) {
  return x(this, void 0, void 0, function() {
    return E(this, function(e) {
      return t != null ? [2, loadGraphModel(t)] : [2, loadGraphModel("https://tfhub.dev/mediapipe/tfjs-model/iris/1/default/2", { fromTFHub: true })];
    });
  });
}
function ot(t, n) {
  if (t.mesh instanceof Tensor) {
    var i = tidy(function() {
      var i2 = tensor1d([n - 1, 0, 0]), u2 = tensor1d([1, -1, 1]);
      return tidy(function() {
        return [concat([sub(n - 1, slice(t.boundingBox.topLeft, 0, 1)), slice(t.boundingBox.topLeft, 1, 1)]), concat([sub(n - 1, slice(t.boundingBox.bottomRight, 0, 1)), slice(t.boundingBox.bottomRight, 1, 1)]), mul(sub(i2, t.mesh), u2), mul(sub(i2, t.scaledMesh), u2)];
      });
    }), u = i[0], c = i[1], h = i[2], l = i[3];
    return Object.assign({}, t, { boundingBox: { topLeft: u, bottomRight: c }, mesh: h, scaledMesh: l });
  }
  return Object.assign({}, t, { boundingBox: { topLeft: [n - 1 - t.boundingBox.topLeft[0], t.boundingBox.topLeft[1]], bottomRight: [n - 1 - t.boundingBox.bottomRight[0], t.boundingBox.bottomRight[1]] }, mesh: t.mesh.map(function(t2) {
    var e = t2.slice(0);
    return e[0] = n - 1 - t2[0], e;
...
var it;
var st = function() {
  function t(t2, e, n, r, o, i) {
    this.kind = "MediaPipeFaceMesh", this.pipeline = new Z(t2, e, 192, 192, n, o, i), this.detectionConfidence = r;
  }
  return t.getAnnotations = function() {
    ...
    return x(this, void 0, void 0, function() {
      var n, r, i, s, a, u, c, h, l, v, b, P, w2 = this;
      return E(this, function(k2) {
        switch (k2.label) {
          case 0:
            if (n = t2.returnTensors, r = n !== void 0 && n, i = t2.flipHorizontal, s = i !== void 0 && i, a = t2.predictIrises, u = a === void 0 || a, c = t2.input, u && this.pipeline.irisModel == null)
            ...
            }(c), l = h[1], v = tidy(function() {
              return c instanceof Tensor || (c = browser_exports.fromPixels(c)), expandDims(cast(c, "float32"), 0);
            }), getBackend() !== "webgl" ? [3, 2] : (P = env().get("WEBGL_PACK_DEPTHWISECONV"), env().set("WEBGL_PACK_DEPTHWISECONV", true), [4, this.pipeline.predict(v, u)]);
          case 1:
            return b = k2.sent(), env().set("WEBGL_PACK_DEPTHWISECONV", P), [3, 4];
          case 2:
            return [4, this.pipeline.predict(v, u)];
          case 3:
            b = k2.sent(), k2.label = 4;
          case 4:
            return v.dispose(), b != null && b.length > 0 ? [2, Promise.all(b.map(function(t3, n2) {
              return x(w2, void 0, void 0, function() {
                var o, i2, a2, c2, h2, f, d, p, m, v2, b2, y, g, P2, w3 = this;
                return E(this, function(k3) {
                  switch (k3.label) {
                    case 0:
                      return o = t3.coords, i2 = t3.scaledCoords, a2 = t3.box, c2 = t3.flag, h2 = [c2], r || (h2 = h2.concat([o, i2])), [4, Promise.all(h2.map(function(t4) {
                        return x(w3, void 0, void 0, function() {
                          return E(this, function(e) {
                            return [2, t4.array()];
                          });
                        });
                    ...
                    case 1:
                      if (f = k3.sent(), d = f[0], c2.dispose(), d < this.detectionConfidence && this.pipeline.clearRegionOfInterest(n2), r)
                        return p = { kind: "MediaPipePredictionTensors", faceInViewConfidence: d, mesh: o, scaledMesh: i2, boundingBox: { topLeft: tensor1d(a2.startPoint), bottomRight: tensor1d(a2.endPoint) } }, s ? [2, ot(p, l)] : [2, p];
                      for (P2 in m = f.slice(1), v2 = m[0], b2 = m[1], i2.dispose(), o.dispose(), y = { kind: "MediaPipePredictionValues", faceInViewConfidence: d, boundingBox: { topLeft: a2.startPoint, bottomRight: a2.endPoint }, mesh: v2, scaledMesh: b2 }, s && (y = ot(y, l)), g = {}, T)
                        (u || P2.includes("Iris") === false) && (g[P2] = T[P2].map(function(t4) {
                          return y.scaledMesh[t4];
                        }));
...
function at(t, e) {
  return t === void 0 && (t = it.mediapipeFacemesh), e === void 0 && (e = {}), x(this, void 0, void 0, function() {
    return E(this, function(n) {
      if (t === it.mediapipeFacemesh)
        return [2, tt(e)];
